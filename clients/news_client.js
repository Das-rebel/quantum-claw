...
class NewsClient {
  constructor(config = {}) {
    this.cerebrasKey = config.cerebrasApiKey || process.env.CEREBRAS_API_KEY || process.env.CEREBRAS_API_KEY;
    this.groqKey = config.groqApiKey || process.env.GROQ_API_KEY || '${process.env.GROQ_API_KEY}';
